...
| Toggle | Description |
|--------|-------------|
| `accessories.InventoryKeyMixin` | Pressing the Accessories key while another screen like crafting table is open closes it in order to behave like vanilla inventory |
