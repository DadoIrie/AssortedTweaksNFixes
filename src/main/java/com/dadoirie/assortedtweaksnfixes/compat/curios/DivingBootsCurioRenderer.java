...
/**
 * Curios "feet" slot renderer for Create's copper/netherite diving boots. Reuses the same
 * humanoid armor texture (layer_1) that {@code BaseArmorItem} renders for the vanilla feet slot,
 * since neither variant implements {@code LayeredArmorItem}.
 */
public class DivingBootsCurioRenderer implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext,
        ...
        if (!(stack.getItem() instanceof DivingBootsItem item)) return;
        ...
        ResourceLocation texture = item.getArmorTexture(stack, entity, EquipmentSlot.FEET, materialLayer, false);
