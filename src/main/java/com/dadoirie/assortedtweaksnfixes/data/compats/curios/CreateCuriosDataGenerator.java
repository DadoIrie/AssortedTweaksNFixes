...
public class CreateCuriosDataGenerator {

    private static final String DATA_OUT = "src/generated/resources/overlay_create/data";
    ...
    public static void run() throws IOException {
        System.out.println("Starting Create backtank Curios data generation...");
        ...
        System.out.println("Create backtank Curios data gen complete.");
    }
}
