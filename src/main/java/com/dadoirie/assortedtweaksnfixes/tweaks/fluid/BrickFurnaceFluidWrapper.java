...
public class BrickFurnaceFluidWrapper implements IFluidHandler {

    private static final String TAG_KEY = "assortedtweaks_lava_mb";
    private static final int CAPACITY = 1000;

    private final AbstractBrickFurnaceBlockEntity furnace;

    public BrickFurnaceFluidWrapper(AbstractBrickFurnaceBlockEntity furnace) {
